"""
Synthetic Data Generation Framework for sys-scan-graph

This module provides a framework for generating synthetic security scan data
that matches the ground truth schema, enabling training of fine-tuned models
for local inference without external API calls.
"""
